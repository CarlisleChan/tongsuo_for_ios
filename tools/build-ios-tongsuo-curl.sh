...
echo "https://github.com/Tongsuo-Project/curl.git"

DEVELOPER=$(xcode-select -print-path)
rm -rf "${LIB_DEST_DIR}" "${LIB_NAME}"
git clone --depth=1 https://mirror.ghproxy.com/https://github.com/Tongsuo-Project/curl.git ${LIB_NAME}
...
function configure_make() {
    ...
    OPENSSL_OUT_DIR="${pwd_path}/../output/ios/tongsuo-${ARCH}"
